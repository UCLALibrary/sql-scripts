...
--left OUTER JOIN CIRCCHARGES_VW cc ON mm.MFHD_ID = cc.MFHD_ID
            ...
            WHERE bt.bib_format = 'am'
              ...
              AND normalized_call_no between vger_support.NormalizeCallNumber('Q') and vger_support.NormalizeCallNumber('Z')
...
AND     (
         ...
         OR  EXISTS
             ...
             AND NOT EXISTS
         (select * from circ_trans_archive where item_id = i.item_id
                     and discharge_date > to_date('20040101', 'YYYYMMDD') )  -- equals zero chargeouts after 2004
