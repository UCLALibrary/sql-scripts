select 
	...
	Case
		When len('"' + coalesce(dbo.build_sc_types(A.ScholCommTypes), 'N/A') + '"') = 2 Then 'N/A'
		Else '"' + coalesce(dbo.build_sc_types(A.ScholCommTypes), 'N/A') + '"'
	End AS Topics
from 
	dbo.Session s
...
where 
	SessionDateTime between '2014-07-01 00:00:00' and '2016-06-30 23:59:59'
