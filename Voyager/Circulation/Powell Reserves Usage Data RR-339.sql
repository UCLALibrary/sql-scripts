...
, ( select count(*)
    ...
    and charge_date_time between to_date('20170925', 'YYYYMMDD') and to_date('20171215 235959', 'YYYYMMDD HH24MISS')
) as charges
, i.historical_browses as "BROWSES*"
, ( select count(*)
    from ucladb.hold_recall_item_archive
    where item_id = mi.item_id
    and hold_recall_status_date between to_date('20170925', 'YYYYMMDD') and to_date('20171215 235959', 'YYYYMMDD HH24MISS')
...
, ( select coalesce(sum(reserve_charges), 0)
    ...
    where item_id = mi.item_id
    and effect_date between to_date('20170925', 'YYYYMMDD') and to_date('20171215 235959', 'YYYYMMDD HH24MISS')
) as reserves
