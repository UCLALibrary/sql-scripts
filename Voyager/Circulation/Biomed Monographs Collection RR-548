...
WHERE           bt.bib_format = 'am'
           ...
           -- and mm.normalized_call_no not like '*%'                                                          
            ...
            AND l.location_code in ('bi', 'bi*', 'bi**', 'bicotf', 'birf', 'biwt')
            --('sm', 'smansmav', 'smnbks', 'smrf', 'smrfatls', 'smrfbiog', 'smrfconf', 'smrfdict', 'smrfdsk', 'smrfwt', 'smsctallm', 'smwt')
            --('sg', 'sgan', 'sgnbks', 'sgrf', 'sgrfabst', 'sgrfatlslo', 'sgrfatlssh', 'sgsctallm', 'sgwt')
