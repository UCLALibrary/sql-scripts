...
WHERE
      bt.bib_format = 'am'
     -- AND bt.begin_pub_date < to_date('20110101', 'YYYYMMDD')
     ...
     AND  EXISTS
         (select * from circcharges_vw where item_id = i.item_id
                     ...
                     AND normalized_call_no between vger_support.NormalizeCallNumber('A') and vger_support.NormalizeCallNumber('Z 6972')
