...
INNER JOIN CIRCCHARGES_VW cc ON i.item_ID = cc.item_ID
                    ...
                    WHERE bt.bib_format = 'am'
                      ...
                      AND l.location_name NOT LIKE 'CLICC%'
                      AND l.location_name NOT LIKE '%Reserves%'
                      AND l.location_code NOT LIKE '%perm%'
                      --AND l.location_code != 'cl'
    ...
    ORDER BY charges DESC --mm.normalized_call_no
